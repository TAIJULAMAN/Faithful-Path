...
function QuranDetails() {
  ...
  if (loading) {
    return <div className="text-center py-10 text-lg text-gray-500">Loading Surah...</div>;
  }

  if (error) {
    return <div className="text-center py-10 text-red-500 text-xl">Error: {error}</div>;
  }
  ...
  return (
    <div className="bg-[#f8ebd5] min-h-screen py-12 px-4 lg:px-28 text-[#2e424d]">
      ...
      <div className="text-center mb-12">
        <h1 className="text-6xl font-bold text-[#2e424d] mb-6 transition-all duration-300 ease-in-out">﷽</h1>
        <p className="text-2xl text-gray-600">{surahName} - বাংলা অনুবাদ ও তাফসীর</p>
      </div>

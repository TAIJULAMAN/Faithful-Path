...
function About() {
  return (
    <div className="bg-[#F7F3DE] text-[#2e424d] px-[100px] py-20 text-xl">
      <h3 className="text-3xl font-bold pb-20 text-center">
      ...
      <div className="flex gap-5">
        ...
        <div className="mt-4 sm:mt-0">
          <h4 className="text-lg text-gray-700 font-semibold">
            মোঃ শাহ আমান পাটোয়ারী
          </h4>
          <p className="text-indigo-600">জুনিয়র ওয়েব ডেভেলপার</p>
          <p className="text-gray-600 mt-2">
            আমি বিশ্বস্ত পথ নামে ওয়েবসাইট তৈরি করেছি। আমার প্রযুক্তিগত দক্ষতা
            এবং সৃজনশীলতা ব্যবহার করে, আমি এমন একটি প্ল্যাটফর্ম তৈরি করতে চাই যা
            সম্প্রদায়ের জন্য মূল্যবান তথ্য ও শিক্ষা প্রদান করে। কাজের প্রতি
            আগ্রহ এবং নিয়ন্ত্রিত সম্ভাবনা নতুন চ্যালেঞ্জ মোকাবিলা করতে এবং
            উন্নত প্রযুক্তি ব্যবহার করে উদ্ভাবনী সমাধান দিতে সাহায্য করেছে।
          </p>
